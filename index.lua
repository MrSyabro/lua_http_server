        ...
        <div class="container my-5">
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    ...
                    <p class="lead">В последнем обновлении была добавлена микро библиотека для генерации HTML функциями Lua. Скрипт <a href="forms.lua">forms</a> демонстрирует ее работу.</p>
                    <hr>
